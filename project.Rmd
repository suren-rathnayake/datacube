...
There appear to be relationship in this case - even though there is some time lag is present
in it. Quantify the relationship.
...
```
In this case, around two thirds of the time, changes in employees numbers may indicate the
...
I have considered various linear fits to the stock values. Although, the effect of linear fit
